...
void* postprocess_yolov5s(nn_output *pout)
{
    ...
    yolov5_buffer[0] = (float*)pout->out[0].buf;
    yolov5_buffer[1] = (float*)pout->out[1].buf;
    yolov5_buffer[2] = (float*)pout->out[2].buf;
...
void* postprocess_yolov5s_dequant(nn_output *pout)
{
    ...
    yolov5_buffer[0] = fp32_buffer[0];
    yolov5_buffer[1] = fp32_buffer[1];
    yolov5_buffer[2] = fp32_buffer[2];
